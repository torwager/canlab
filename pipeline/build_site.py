...
Outputs:
  ...
  site/data/{people,news_posts,news,research,resources,join,candidates,discussions}.json  copied from data/
...
def main():
    ...
    for name in ("people.json", "research.json", "resources.json", "join.json", "news_posts.json", "news.json", "candidates.json", "discussions.json", "events.json"):
    ...
    pages = [("", "weekly", "1.0"), ("publications.html", "daily", "0.9"), ("research.html", "monthly", "0.8"), ("people.html", "monthly", "0.8"), ("news.html", "daily", "0.7"),
             ("resources.html", "monthly", "0.7"), ("network.html", "weekly", "0.5"), ("bibliometrics.html", "weekly", "0.5"), ("join.html", "monthly", "0.6"), ("discuss.html", "weekly", "0.4"), ("about.html", "monthly", "0.5")]
