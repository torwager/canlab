"""CANlab in the news: news stories, podcast episodes and blog posts about the lab and its work.
...
PODCAST_TERMS = ["Tor Wager"]
KEEP_DAYS = 180
RELEVANT = re.compile(r"wager|canlab|dartmouth", re.I)
...
def llm_filter(items):
    ...
    system = ("You curate the 'in the news' page of the Cognitive and Affective Neuroscience Lab (Tor Wager, Dartmouth College; "
              "pain, placebo, emotion, brain imaging, neuromarkers, pain reprocessing therapy). Given a numbered list of headlines "
              "(news stories, podcast episodes, blog posts) with their sources, answer for each whether it is genuinely about this lab, "
              "Tor Wager, or research the lab is known for and likely quoted in. Answer false for unrelated people named Wager, betting "
              "or wagering, sports, and generic items. Return JSON {keep: [bool,...]} with exactly one boolean per line, in order.")
    out = []
